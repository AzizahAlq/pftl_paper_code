...
BASE_DIR = "/Users/azizahalq/Desktop/PFTL_Binary/logs/fedclassavg_clf_only"
...
def load_client_file(base_dir: str, client_id: str) -> pd.DataFrame:
    #/Users/azizahalq/Desktop/PFTL_Binary/logs/fedclassavg_clf_only/client1_local_global_macro_f1_by_round.csv
...
def main():
    ...
    plt.title("FEDClassAVG — Macro-F1 vs Rounds (Average across clients)", fontsize=18)
    ...
    out_path = os.path.join(OUT_DIR, "FEDClassAVG_all_clients_local_vs_global.png")
