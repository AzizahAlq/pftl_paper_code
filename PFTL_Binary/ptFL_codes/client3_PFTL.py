...
# ============================================================
# client3_PFTL_share_shared_dense_gamma_logs_CLIENT3_PRINT_NO_PLOTS_FIXED.py
# (STANDARDIZED)
...
# - Client6-style final print + CSV logs
# - Adds ONE summary CSV: local_macro_f1 vs global_macro_f1 (one row per round)
# ============================================================
