...
BASE_DIR = "/Users/azizahalq/Desktop/PFTL_Binary/logs/fedavg_full_model"
...
def main():
    ...
    plt.title("FEDAVG — Macro-F1 vs Rounds (Average across clients)", fontsize=18)
    ...
    out_path = os.path.join(OUT_DIR, "FEDAVG_all_clients_local_vs_global.png")
