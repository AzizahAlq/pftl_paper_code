...
# ============================================================
# client3_FEDAVG_full_input_feat1_shared_clf_LOCAL_GLOBAL_SAME_CSV.py
#
# FIXED: adds INIT handshake so client will not block forever if
# the aggregator consumes first update as INIT and keeps round=0.
#
# FedAvg FULL sharing (trainable layers):
#   - input_adapter (Conv1D)
#   - feat1
#   - shared_dense
#   - clf
#
# pool/gap have NO weights.
# ============================================================
...
def load_dataset():
    ...
    # NOTE: your file name mentions minmax, but we keep StandardScaler for consistency with others.
    # If you truly want MinMaxScaler, tell me and I'll switch it.
    sc = StandardScaler()
