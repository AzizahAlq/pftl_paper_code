...
OUT_DIR  = os.path.join(BASE_DIR, "plots_FedRep")
os.makedirs(OUT_DIR, exist_ok=True)

def load_all_files(base_dir):
    pattern = os.path.join(base_dir, "fedrep_repr_shared_head_private", "client*_local_global_macro_f1_by_round.csv")
...
def main():
    ...
    plt.title("FedRep — Macro-F1 vs Rounds (Avrage across all clients)", fontsize=18)
    ...
    out_path = os.path.join(OUT_DIR, "Fedrep_all_merged_local_vs_global.png")
