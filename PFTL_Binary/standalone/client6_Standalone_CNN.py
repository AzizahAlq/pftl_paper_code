...
# ============================================================
# client6_CICIDS2017_STANDALONE_FULL_PRINT_NO_PLOTS.py  (FULL)
# Standalone (NO server, NO FL, NO plots)
# Client6-style printing
# Same shared_dense naming for comparability
...
#  PUT THE CORRECT IDS2017 PATH HERE
CSV_PATH  = "/Users/azizahalq/Desktop/PFTL_Binary/Datasets_processed/D3_CICIOT2023/final_cic_ids_clean.csv"
LABEL_COL = "binary_label"

# Fixed to always be 4/4/4 (your standard)
CONV_FILTERS = 4
PRIVATE_DIM  = 4
SHARED_DIM   = 4
...
SPLIT_SEED = SEED           # stable split (same style as others)
...
print(f"[{CLIENT_ID}] Dataset={DATASET_NAME}")
print(f"[{CLIENT_ID}] CSV={CSV_PATH}")
...
# =========================
# Model (standard template: input_adapter -> feat1 -> shared_dense -> clf)
# =========================
