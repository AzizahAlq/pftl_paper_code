...
# ============================================================
# Standalone_CNN_CLIENT5_BCCC_NRC_2024_SPLIT70_15_15_LOGS.py
# ============================================================
...
# Data / Paths
# -------------------------
CSV_PATH  = "/Users/azizahalq/Desktop/PFTL_project3/Datasets_processed/D5_CIC-BCCC-NRC_2024/Client5_Balanced_Final.csv"
LABEL_COL = "Label"

OUT_DIR = "/Users/azizahalq/Desktop/PFTL_project3/standalone_outputs/client5_bccc_logs"
os.makedirs(OUT_DIR, exist_ok=True)

EPOCH_LOG_CSV   = os.path.join(OUT_DIR, "standalone_client5_epoch_log.csv")
RUN_SUMMARY_CSV = os.path.join(OUT_DIR, "standalone_client5_run_summary.csv")
...
# ✅MUST MATCH PTFL CLIENT5 MODEL EXACTLY
def build_cnn(input_shape, num_classes):
    ...
    model = models.Model(inp, out, name="Standalone_Client5_CNN")
